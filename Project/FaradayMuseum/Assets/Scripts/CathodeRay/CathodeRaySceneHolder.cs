...
public class CathodeRaySceneHolder : MonoBehaviour
{
    ...
    */
    ...
    private void UpdateSceneHolder(Achievements achievement)
    {
        ...
        {
            // check if previous achivement (circle1Done) is completed
            if (circle1Done)
            {
                AchivementDone(achievement);
                circle2Done = true;
        ...
        {
            // check if previous achivement (circle2Done) is completed
            if (circle2Done)
            {
                AchivementDone(achievement);
                spiral1Done = true;
